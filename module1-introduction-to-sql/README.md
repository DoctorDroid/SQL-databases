...
- How many of each specific subclass?
       ...
       NECROMANCER - 11
       THIEF - 51
- How many total Items?  174 DISTINCT ITEMS, 898 TOTAL INVENTORY ITEMS
- How many of the Items are weapons? 36 How many are not? 137
- How many Items does each character have? 1-5 (Return first 20 rows)
- How many Weapons does each character have? 0-2 (Return first 20 rows)
